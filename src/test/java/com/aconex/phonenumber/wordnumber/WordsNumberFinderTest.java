...
@Test
public class WordsNumberFinderTest {

    public void should_find_words_to_replace_numbers() {
        WordDictionary dict = WordDictionaryHelper.buildDict("MYSELF");

        List<WordsNumber> wordNumbers = new WordsNumberFinder(new WordsSplitter(dict), "697353").findWordNumbers();
    ...
    public void should_ignore_non_number_characters_in_phone_number() {
        ...
        List<WordsNumber> wordNumbers = new WordsNumberFinder(new WordsSplitter(dict), "69.73.53").findWordNumbers();
    ...
    public void should_return_empty_list_for_invalid_number()  {
        ...
        List<WordsNumber> wordNumbers = new WordsNumberFinder(new WordsSplitter(dict), "asdf").findWordNumbers();
    ...
    public void should_return_quickly_for_long_numbers()  {
        ...
        List<WordsNumber> wordNumbers = new WordsNumberFinder(new WordsSplitter(dict), "861373466543745").findWordNumbers();
    ...
    public void should_return_empty_list_for_very_long_numbers()  {
        ...
        List<WordsNumber> wordNumbers = new WordsNumberFinder(new WordsSplitter(dict), "2323232323232323").findWordNumbers();
    ...
    public void should_return_empty_for_null()  {
        ...
        List<WordsNumber> wordNumbers = new WordsNumberFinder(new WordsSplitter(dict), null).findWordNumbers();
